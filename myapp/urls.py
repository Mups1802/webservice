...
from .views import TemperatureDetailView,  TemperatureListView, TemperatureCreateAPIView, LatestTemperatureAPIView, temperature_monitor, LatestHumidityAPIView
...
urlpatterns = [
    ...
    path('api/latest-humidity/', LatestHumidityAPIView.as_view(), name='latest-temperature'),
